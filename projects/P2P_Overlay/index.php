<html>
	<head>
		<title>P2P Overlay and the AS-level Underlay</title>
	...
	<body onresize="resize()">
		...
		<div style="position:absolute; margin-top:90px; width:100%; height:auto;">
			<div style="position: relative; margin-top:10px; margin-left:170px; margin-right:170px;">
				<iframe id="iFrame1" name="iFrame1" width="100%" onload="this.height=iFrame1.document.body.scrollHeight+100" frameborder="0" src="P2P_Overlay.html"></iframe>
			</div>
		</div>
	</body>
</html>